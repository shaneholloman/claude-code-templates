...
// SVG flag components for top countries
...
export default function CountryFlag({ code, className }: CountryFlagProps) {
  ...
  if (!FlagComponent) {
    // Fallback to a generic globe icon if flag not found
    return (
